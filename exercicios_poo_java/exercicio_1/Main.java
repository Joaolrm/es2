...
public class Main {
    public static void main(String[] args) {
        ...
        empresa.contratarFuncionario(new Funcionario("Eduarda", 28, 2500.00, "Analísta"));
        empresa.contratarFuncionario(new Funcionario("Christian", 23, 3200.00, "ABAP"));
        empresa.contratarFuncionario(new Funcionario("Cabelo", 40, 47000.00, "Arquiteto de software"));
